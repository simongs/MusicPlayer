...
//  MusicPlayer
//
//  Created by chopokmado on 2020/03/15.
//  Copyright © 2020 chopokmado. All rights reserved.
//
...
class ViewController: UIViewController, AVAudioPlayerDelegate {
    ...
    // IBOutlet => Modifier
    // 이걸 명시해야만 UI에서 인지할 수 있다.
    // 아울렛이란 다른 객체를 참조하는 객체의 속성이다.
    // 인터페이스 빌더와 연결을 위한 객체의 속성
    // MARK: IBOulet
    ...
    @IBAction func touchUpPlayPauseButton(_ sender: UIButton) {
        ...
        //String(format: "%02ld:%02ld:%02ld", minute, second, milisecond)
